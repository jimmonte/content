...
> **Note:** This function is almost identical to {{jsxref("Function/apply", "apply()")}}, except that `call()` accepts an **argument list**, while `apply()` accepts a **single array of arguments  or an array-like object** — for example, `func.apply(this, ['eat', 'bananas'])` vs. `func.call(this, 'eat', 'bananas')`.
